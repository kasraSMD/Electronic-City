...
public class Main {
    public static void main(String[] args) {
        ...
        String countryName = null;
                ...
                try {
                    File musicPath=new File("src\\music\\music.wav");
        ...
        if(file.isFile()){
            ...
            capital.AddCapitalPerson("faraz", "samadi", 1379, "shiraz", Person.Job.pilot, "Male", 100, false);
            ...
            capital.AddCapitalPerson("kasra", "samadi", 1381, "isfahan", Person.Job.pilot, "Male", 170, false);
            capital.AddCapitalPerson("masih", "baqheri", 1360, "isfahan", Person.Job.pilot, "Male", 180, false);
            capital.AddCapitalPerson("kasra", "rezaei", 1379, "isfahan", Person.Job.pilot, "Male", 190, false);
            capital.AddCapitalPerson("milad", "hatami", 1350, "mashhad", Person.Job.pilot, "Male", 150, false);
            capital.AddCapitalPerson("reza", "jafarinasab", 1335, "kerman", Person.Job.pilot, "Male", 133, false);
            ...
            capital.AddCapitalPerson("ali", "goli", 1365, "isfahan", Person.Job.pilot, "Male", 145, false);
            ...
            capital.AddCapitalPerson("parvaneh", "akbari", 1354, "roudbar", Person.Job.crew, "female", 86, false);
        ...
        while (true){
            ...
            switch (sc.nextInt()){
                ...
                case 5://music
                    boolean situation7=true;
                    while (situation7){
                        System.out.println(ConsoleColors.GREEN_BRIGHT+"(1)Start Music\n(2)Pause Music\n(3)Back"+ConsoleColors.RESET);
                        int ans=sc.nextInt();
                        switch (ans){
                            case 1://Start Music
                                if (!clip.isRunning()){
